 ...
 * @return ?array<int,array{id: int, date_end: string, lot_name: string, price_start: int,
 ...
 * @return ?array{id: int, user_id: int, date_end: string, lot_name: string, img_url: string,
 ...
 * @param mysqli $connect Ресурс соединения
 * @param array $data данные для добавления лота в БД
 * @return ?boolean
 **/
function set_lot(mysqli $connect, array $data): ?bool
{
    $sql = 'INSERT INTO lots(name, description, price, date_end, step_bet, cat_id, img_url, user_id)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?)';
 ...
 * @param int $offset смещение
 * @return ?array<int,array{id: int, author_id: int, date_end: string, lot_name: string,
 *     img_url: string, description: string, price_start: int, step_bet: int, cat_name: string, cost: int}
 */
 ...
 * @return ?array<int,array{id: int, author_id: int, date_end: string, lot_name: string, img_url: string,

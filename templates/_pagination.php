...
<?php ?>
    <ul class="pagination-list">
        <li class="pagination-item pagination-item-prev">
            <a href="<?= $cur_page > 1 ? create_new_url($path, [$tab => $value, 'page' => $cur_page - 1]) : '#'; ?>">Назад</a>
        </li>
        ...
        <li class="pagination-item pagination-item-next">
            <a href="<?= $cur_page < $pages_count ? create_new_url($path, [$tab => $value, 'page' => $cur_page + 1]) : '#'; ?>">Вперед</a>
        </li>
    </ul>
<?php endif; ?>

 ...
 * @param array $time массив [количество часов, количество минут]
 * @return string
 */
...
function get_dt_range(string $date_end, bool $is_bet = true): array
{
    ...
    $hours_until_end = (int)floor($ts_diff / SECS_IN_HOUR);
    $minutes_until_end = (int)floor($ts_diff % SECS_IN_HOUR / SECS_IN_MINUTE);
    $seconds_until_end = (int)floor($ts_diff % SECS_IN_MINUTE);
